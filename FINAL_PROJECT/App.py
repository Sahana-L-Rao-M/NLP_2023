...
import sys
sys.path.insert(0,'/home/niharika/AI-Resume-Analyzer/App')
...
# sql connector
connection = pymysql.connect(host='localhost',user='root',password='NEWPASSWORD',db='cv')
...
def run():
    ...
    link = '<b>Built with 🤍 by <a href="https://dnoobnerd.netlify.app/" style="text-decoration: none; color: #021659;">NLP Team</a></b>' 
